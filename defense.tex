...
\begin{frame}{Types of Impact} 
  ...
  \note{
    \begin{itemize}
      ...
      \item Building upon the examples we previously looked at, I'll introduce
        the two different types of impact from a modification that we consider
      \item The first considers statements which may-impact a modification
      \item For example, suppose that 
    \end{itemize}
  }
\end{frame}
