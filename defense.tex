...
\note{
  \begin{itemize}
    ...
    \item Note that identifying relevant transfer functions is abstract interpretation
    specific: it cannot 
  \end{itemize}
}
\end{frame}

\begin{frame}{Preserving Analysis Results}
\end{frame}
...
\begin{frame}{Effect of Size of Program Modification}
\end{frame}
...
\begin{frame}{Conclusion}
  \begin{itemize}[<+->]
    ...
    \item Incremental thread-modular analysis
  \end{itemize}
  \pause
  \begin{center}
  \Huge Questions?
  ...
  \note{
    \begin{itemize}
      \item So, in conclusion I presented a constraint-based thread-modular
        abstract interpretation algorithm first handling sequentially consistent programs
      \item Then, I showed how we created a weak-memory aware analyzer for TSO, PSO, and RMO.
      \item And finally, I showed how we propose to make the analysis
        incremental by designing a weak-memory aware change-impact analysis.
