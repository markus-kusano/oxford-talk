...
\begin{frame}[c]{Completed Research}
  ...
  \note{
    \begin{itemize}
      \item In summary, my dissertation addresses the following open research
        questions within the area of verifying the correctness of concurrent
        programs
...
\note {
  Now that I've gone over a recap of my entire dissertation, I'll go over
  examples motiviating the last chapter on the incremental analysis.
}
\end{frame}
...
\begin{frame}{Relevant Transfer Functions}
...
%  \note{
%    \begin{itemize} 
%      \item Very briefly, I'll go over how we plan to create an incremental
