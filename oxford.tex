...
\begin{frame}[c]{Proposed Research}
  ...
  \begin{center}
    \huge
    \textbf{Incremental} Thread-Modular Static Verification for \textbf{Strong} and \textbf{Weak} Memory
  \end{center}
  \note{
    \begin{itemize}
...
\section{Flow-sensitive Thread Modular Abstract Interpretation [FSE16]}
...
\section{Thread Modular Analysis for Weak Memory [FSE17]}
...
\section{Incremental Thread Modular Analysis [Future Work]}
