...
\note{
  \begin{itemize}
    \item In this talk today I'lll focus on past work on numerical verification
      and our current unpublished directions forward
  \end{itemize}
}
...
\begin{frame}{Conclusion}
  ...
  \note{
    \begin{itemize}
      ...
      \item I showed future work extending it to soundly handle TSO, PSO, and
        RMO
      \item And also I showed the intuition behind making the analysis
        incremental
    \end{itemize}
  }
\end{frame}
