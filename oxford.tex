...
%  \only<5>{
%    \begin{itemize}
%      \item {\transparent{0.4}$(x = 4 \land \mathit{flag} = 0)$;}
%      \item {\transparent{0.4}$(x = 5 \land \mathit{flag} = 0)$;}
%      \item {\transparent{0.4}$(x = 0 \land \mathit{flag} = 0)$;}
%      \item {\transparent{0.4}$(x = 5 \land \mathit{flag} = 1)$;}
%      \item $(x = 4 \land \mathit{flag} = 1)$; and
%      \item $(x = 0 \land \mathit{flag} = 1)$.
%    \end{itemize}
%  }
...
%\end{frame}
%
%\begin{frame}{Extension to TSO/PSO/RMO}
%\end{frame}
%
